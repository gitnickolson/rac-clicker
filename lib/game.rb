...
class Game
  def initialize
    ...
    @mouse_listener = Components::Listeners::Mouse.new(click)
  ...
  def add_mouse_listener
    mouse_listener.add_listener(raccoon.x_coordinate, raccoon.y_coordinate, raccoon.image_width, raccoon.image_height)
  end
